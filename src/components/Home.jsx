...
const Home = () => {
  return (
    <div id="home" className="flex flex-col-reverse md:flex-row w-full mt-[60px] justify-between home mx-auto items-center mb-24">
      <div className="text-[32px] md:text-[60px] font-bold text-[#606060] flex flex-col w-full mx-auto items-center md:items-start mt-10 md:mt-0 flex-nowrap ">
        <h1>Hello!</h1>
        <h2>
          I'm {}
