...
const Home = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row w-full mt-[60px] justify-between home mx-auto items-center">
      <div className="text-[32px] md:text-[60px] font-bold text-[#606060] flex flex-col w-full mx-auto items-start mt-10 md:mt-0 flex-nowrap">
        ...
        <h2 className="flex-nowrap text-[#ff2e63] md:text-[40px] flex">Software Developer.</h2>
        <button className="bg-[#ff2e63] text-white px-4 py-2 rounded-[50px] mt-8 text-[22px] font-[400]">
          Download Resume 
        </button>
      </div>
